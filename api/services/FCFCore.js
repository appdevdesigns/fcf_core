...
module.exports= {
         ...
         * @function __mockMe
         *
         * used in UnitTesting to override given Models and
         *
         */
        __mockMe:function(opts) {
         ...
         *
         * Return a FCFPerson Model representing the current guid 
         * 
         * @param {obj} req
         */
        personForSession: function(req) {
            ...
            // Requires a req object
            if (typeof req == 'undefined') {

                var err = new Error('FCFCore.personForSession() requires a REQ object');
                AD.log.error(err);
                dfd.reject(err)
                return dfd;
            } 
            ...
            if ((sails.config.fcfcore)
                && (sails.config.fcfcore.test) 
                && (sails.config.fcfcore.test.user)) {
...
//         /**
//          *  @function teamsbyGUID
//          *
//          *  Return an array of teams (table: Ministries) for the given GUIDs.
//          *
//          *  @param [object] options     : list of options
//          *                  options.guids : list of user guids
